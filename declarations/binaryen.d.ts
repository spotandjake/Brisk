declare namespace binaryen {
  ...
  class Module {
    ...
    getTableSegments(table: string): any;
    addPassiveElementSegment(table: string, funcNames: string[]): any;
    addActiveElementSegment(table: string, name: string, funcNames: string[], offset: ExpressionRef);
